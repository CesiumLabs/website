    ...
    componentDidMount() {
        fetch(
            ...
            .then((data) => {
                ...
                const id = videoData.link.substr(
                    videoData.link.indexOf("=") + 1
                );
        ...
        return (
            <div className="container mx-auto text-center min-h-screen">
                    ...
                    <div className="flex items-center text-center px-8 md:px-12">
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 md:text-base">
                                We are a community focused on programming; No
                                matter if we know how to provide support or not,
                                we may be able to redirect you somewhere that
                                might!
                            </p>
                ...
                <div className="hidden lg:block pb-10 pt-3 border-b border-gray-600">
                    <div
                        className="flex bg-gray-900 h-96"
                        style={{ height: "600px" }}
                    >
                        <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-500 md:text-base">
                                    We are a community focused on programming;
                                    No matter if we know how to provide support
                                    or not, we may be able to redirect you
                        ...
                        <div className="text-center pb-5">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 md:text-base">
                                    We help in Discord Bot Development, Web
                                    Development, Discord Bot Hosting, etc.
                                </p>
                                <p className="text-sm text-gray-500 md:text-base">
                                    We also make{" "}
                                    <a
                                        className="text-blue-400 hover:text-blue-500 cursor-pointer"
                                        href="https://www.youtube.com/channel/UCvklmpoAZntoOpr7EyTierA"
                                    >
                                        YouTube
                                    </a>{" "}
